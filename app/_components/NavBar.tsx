    ...
    >
      <div className="site-container flex items-center justify-between py-4">
        ...
        <div className="flex items-center gap-3">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-42">
        ...
        <nav className="hidden md:flex items-center gap-5 text-sm">
          <Link href="/" className={`nav-link-michelin ${isActive("/") ? "font-bold text-primary-dark" : ""}`}>
            Accueil
          </Link>

          <Link
            href="/product"
            className={`nav-link-michelin ${isActive("/product") ? "font-bold text-primary-dark" : ""}`}
          >
            Nos pneus
          </Link>
          ...
          <Link
            ...
            className={`nav-link-michelin ${isActive("/expertise-michelin") ? "font-bold text-primary-dark" : ""}`}
          >
          ...
          <Link
            href="/challenges"
            className={`nav-link-michelin ${isActive("/challenges") ? "font-bold text-primary-dark" : ""}`}
          >
            Défis
          </Link>
          ...
          <Link
            ...
            className={`nav-link-michelin ${
              isActive("/en-mouvement-pour-demain") ? "font-bold text-primary-dark" : ""
            }`}
          >
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <div>
            ...
            >
              {user ? (
                <>
                  <DropdownItem onClick={() => router.push("/profile")}>Mon profil</DropdownItem>
                  <DropdownItem onClick={handleSignOut}>Se déconnecter</DropdownItem>
                </>
              ) : (
                <>
                  <DropdownItem onClick={() => router.push("/auth")}>S'authentifier</DropdownItem>
                </>
              )}
            </Dropdown>
          </div>
