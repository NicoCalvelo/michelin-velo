...
export default function ChallengesPage() {
  ...
  const [activeStatus, setActiveStatus] = useState<"all" | ChallengeStatus>(
    "all",
  );
  ...
  const averageProgress = Math.round(
    CHALLENGES.reduce(
      (total, challenge) => total + challenge.progressPercent,
      0,
    ) / CHALLENGES.length,
  );
  ...
  return (
    <main className="min-h-screen bg-background-dark">
          ...
          <div className="flex flex-col justify-center gap-6">
            <div className="space-y-4">
              <p className="text-sm font-bold uppercase text-secondary-color">
                Challenges Michelin Bike
              </p>
              <h1 className="max-w-3xl text-4xl font-black leading-tight sm:text-5xl">
                Transformez vos sorties en avantages.
              </h1>
              <p className="max-w-2xl text-base leading-7 text-primary-light sm:text-lg">
                Relevez des défis adaptés à votre pratique, faites valider vos
                kilomètres et débloquez des réductions ou des conseils en
                fonction de vos activités à vélo.
              </p>
            </div>
      ...
      <section
        id="strava"
        className="mx-auto max-w-7xl scroll-mt-24 px-4 pb-12 mt-12 sm:px-6 lg:px-8"
      >
        <div className="grid gap-5 rounded-lg border border-gray-200 bg-white p-5 sm:p-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <p className="mt-4 text-sm font-bold uppercase text-primary-color">
              Suivi Strava
            </p>
            <h2 className="mt-2 text-2xl font-black text-primary-dark">
              Validez vos défis avec vos sorties réelles.
            </h2>
            <p className="mt-3 text-sm leading-6 text-gray-600">
              Une fois votre compte connecté, vos activités vélo peuvent
              alimenter automatiquement la progression des défis : distance,
              fréquence, terrain et période.
            </p>
          ...
          <div className="rounded-lg bg-background-dark p-4">
            <div className="rounded-lg bg-primary-dark p-4 text-white">
              <div className="flex items-center justify-between gap-4">
                <div>
                  <p className="text-xs font-bold uppercase text-secondary-color">
                    Activité synchronisée
                  </p>
                  <h3 className="mt-1 text-xl font-black">
                    Sortie route du matin
                  </h3>
                </div>
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-3">
                {[
                  ...
                  <div
                    key={label}
                    className="rounded-lg bg-white p-3 text-primary-dark"
                  >
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <h2 className="mt-1 text-2xl font-black text-primary-dark">
                Un parcours simple, mesurable et récompensé.
              </h2>
              <p className="mt-3 text-sm leading-6 text-gray-600">
                Les avantages ou réductions sont rattachés à votre compte et
                orientent vers le pneu, l&apos;offre ou le revendeur concerné.
              </p>
            </div>
          </div>
          <FilledButton className="mt-3" onClick={() => router.push("#defis")}>
            Voir les défis
          </FilledButton>
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
            {[
              [
                ...
                "1",
                "Choisir",
                "Objectif et avantage visibles avant départ.",
              ],
              [
                Activity,
                "2",
                "Synchroniser",
                "Strava met à jour les kilomètres.",
              ],
              [
                Bike,
                "3",
                "Rouler",
                "La progression évolue après chaque sortie.",
              ],
              [
                Gift,
                "4",
              ...
              >
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                  <div>
                    <div className="flex flex-wrap items-center gap-2">
                      <span
                        className={`rounded-full px-3 py-1 text-xs font-bold ${STATUS_STYLES[challenge.status]}`}
                      >
                    ...
                    <h3 className="mt-3 text-xl font-black text-primary-dark">
                      {challenge.title}
                    </h3>
                    <p className="mt-2 text-sm leading-6 text-gray-600">
                      Objectif de {challenge.distanceGoalKm} km avec validation
                      par {challenge.proof.toLowerCase()}.
                    </p>
                  </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <dd className="mt-1 font-semibold text-primary-dark">
                            {value as string}
                          </dd>
                        </div>
                      </div>
