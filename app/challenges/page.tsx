...
export default function ChallengesPage() {
  ...
  const openMemberSignIn = () => {
    showSignInModal(
      "Connectez-vous à votre espace Michelin",
      "Suivez vos défis, retrouvez vos avantages et synchronisez vos activités depuis votre espace membre.",
      "Se connecter",
    );
  };
  ...
  return (
    <main className="min-h-screen bg-background-dark">
      <section className="bg-primary-dark text-white">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[1fr_0.9fr] lg:px-8 lg:py-14">
          <div className="flex flex-col justify-center gap-6">
            <div className="space-y-4">
              ...
              <p className="max-w-2xl text-base leading-7 text-primary-light sm:text-lg">
                Relevez des défis adaptés à votre pratique, faites valider vos kilomètres et débloquez des bénéfices pensés pour les cyclistes exigeants.
              </p>
            </div>
          ...
          <div className="relative min-h-[360px] overflow-hidden rounded-lg border border-white/15 bg-white/10">
            <Image src="/demo.jpg" alt="Cycliste Michelin en sortie" fill priority sizes="(min-width: 1024px) 45vw, 100vw" className="object-cover opacity-60" />
            <div className="absolute inset-0 bg-primary-dark/45" />
            <div className="relative flex h-full flex-col justify-end p-5 sm:p-6">
              <div className="grid gap-3 sm:grid-cols-3">
                {[
                  ["Défis actifs", `${CHALLENGES.filter((challenge) => challenge.status !== "completed").length}`],
                  ["Progression", `${averageProgress}%`],
                  ["Récompenses", `${completedCount}`],
                ].map(([label, value]) => (
                  <div key={label} className="rounded-lg bg-white p-4 text-primary-dark">
                    <p className="text-xs font-bold uppercase text-primary-color">{label}</p>
      ...
      <section id="expertise" className="mx-auto grid max-w-7xl scroll-mt-24 gap-5 px-4 py-8 sm:px-6 lg:grid-cols-3 lg:px-8">
        {[
          {
            icon: Smartphone,
            title: "Connexion Strava",
            text: "Les sorties peuvent être synchronisées depuis Strava pour suivre automatiquement l'avancement.",
          },
          {
            icon: ShieldCheck,
            title: "Validation claire",
            text: "Chaque défi précise l'objectif, la période, le type de preuve attendu et l'avantage associé.",
          },
          {
            icon: Gift,
            title: "Avantages membres",
            text: "Chaque récompense oriente vers le bon pneu, le bon revendeur ou l'offre e-retail pertinente.",
          },
        ].map((item) => {
          ...
          return (
            <article key={item.title} className="rounded-lg border border-gray-200 bg-white p-5">
              <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-primary-light text-primary-color">
                <Icon className="h-5 w-5" />
              </div>
              <h2 className="mt-4 text-lg font-black text-primary-dark">{item.title}</h2>
      ...
      <section id="premium" className="mx-auto max-w-7xl scroll-mt-24 px-4 pb-8 sm:px-6 lg:px-8">
        <div className="rounded-lg border border-gray-200 bg-primary-dark p-5 text-white sm:p-6">
          <div className="grid gap-5 lg:grid-cols-[1fr_auto] lg:items-center">
            <div className="flex gap-4">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg bg-secondary-color text-secondary-on">
                <LockKeyhole className="h-5 w-5" />
              </div>
              <div>
                <p className="text-sm font-bold uppercase text-secondary-color">Espace utilisateur</p>
                <h2 className="mt-1 text-2xl font-black">Connexion membre et option Premium</h2>
                <p className="mt-2 max-w-3xl text-sm leading-6 text-primary-light">
                  Tout utilisateur peut se connecter pour suivre ses défis. L&apos;option Premium sert d&apos;abonnement pour accéder à certains défis réservés et à des avantages renforcés.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-3 lg:justify-end">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-secondary-color px-4 py-2 text-sm font-semibold text-secondary-on transition-colors hover:bg-secondary-dark"
              >
                Se connecter
              ...
              <Link
                href="/quiz"
                className="inline-flex items-center gap-2 rounded-lg border border-white/60 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-white/10"
              >
                Vérifier mon profil
              </Link>
            </div>
      ...
      <section id="strava" className="mx-auto max-w-7xl scroll-mt-24 px-4 pb-12 sm:px-6 lg:px-8">
        <div className="grid gap-5 rounded-lg border border-gray-200 bg-white p-5 sm:p-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <p className="mt-3 text-sm leading-6 text-gray-600">
              Une fois votre compte connecté, vos activités vélo peuvent alimenter automatiquement la progression des défis : distance, fréquence, terrain et période.
            </p>
          ...
          <div className="rounded-lg bg-background-dark p-4">
            <div className="rounded-lg bg-primary-dark p-4 text-white">
              <div className="flex items-center justify-between gap-4">
                ...
                <span className="rounded-full bg-white/10 px-3 py-1 text-xs font-bold text-secondary-color">Strava</span>
              </div>
              ...
              <article key={challenge.id} className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                ...
                <div className="mt-5">
                  ...
                  <div className="h-2 overflow-hidden rounded-full bg-gray-100">
                    <div className="h-full rounded-full bg-primary-color" style={{ width: `${challenge.progressPercent}%` }} />
                  </div>
                </div>
                ...
                <div className="mt-5 flex flex-col gap-3 border-t border-gray-100 pt-4 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <Link
                    href={action.href}
                    className="inline-flex items-center justify-center gap-2 rounded-lg bg-primary-color px-4 py-2 text-sm font-semibold text-primary-on transition-colors hover:bg-primary-dark"
                  >
      ...
      <section id="participer" className="mx-auto max-w-7xl scroll-mt-24 px-4 pb-14 sm:px-6 lg:px-8">
        <div className="grid items-stretch gap-5 min-[600px]:grid-cols-2">
          <article className="flex h-full flex-col rounded-lg border border-gray-200 bg-white p-5 sm:p-6">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
              <div>
                <p className="text-sm font-bold uppercase text-primary-color">Comment participer</p>
                <h2 className="mt-1 text-2xl font-black text-primary-dark">Un parcours simple, mesurable et récompensé.</h2>
              </div>
              <Link
                href="#strava"
                className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#fc4c02] px-4 py-2 text-sm font-semibold text-white transition-opacity hover:opacity-90"
              >
                <Activity className="h-4 w-4" />
                Connecter Strava
              </Link>
            ...
            <div className="mt-5 grid flex-1 gap-3">
              {[
                ...
                [Gift, "4", "Débloquer", "Le code est rattaché au compte."],
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-2">
                          <StepIcon className="h-4 w-4 shrink-0 text-primary-color" />
                          <h3 className="text-base font-black text-primary-dark">{title as string}</h3>
                        </div>
          ...
          <article id="avantages" className="flex h-full scroll-mt-24 flex-col rounded-lg border border-gray-200 bg-white p-5 sm:p-6">
            <div>
              <p className="text-sm font-bold uppercase text-primary-color">Avantages débloqués</p>
              <h2 className="mt-1 text-2xl font-black text-primary-dark">Une récompense utile au bon moment.</h2>
              <p className="mt-3 text-sm leading-6 text-gray-600">
                Les codes sont rattachés au compte client et orientent vers le pneu, l&apos;offre ou le revendeur le plus pertinent.
              </p>
            </div>

            <div className="mt-5 grid gap-3 sm:grid-cols-3">
              {[
                ["Code", "Remise personnalisée"],
                ["Durée", "15 jours après validation"],
                ["Usage", "E-retail ou revendeur"],
              ].map(([label, value]) => (
                <div key={label} className="rounded-lg bg-gray-50 p-4">
                  <p className="text-xs font-bold uppercase text-gray-500">{label}</p>
                  <p className="mt-2 font-black text-primary-dark">{value}</p>
                </div>
              ))}
            </div>
            ...
            <div className="mt-5 grid flex-1 gap-3">
              {[
                [BadgeCheck, "Validation", "Défi confirmé par l'activité."],
                [Gift, "Récompense", "Remise, pack ou offre partenaire."],
                [Bike, "Produit lié", "Pneu cohérent avec le quiz."],
              ].map(([Icon, title, text]) => {
                const AdvantageIcon = Icon;

                return (
                  <div key={title as string} className="flex gap-3 rounded-lg bg-gray-50 p-3">
                    <AdvantageIcon className="mt-0.5 h-5 w-5 shrink-0 text-primary-color" />
                    <div>
            ...
            <Link
              href="/product"
              className="mt-5 inline-flex w-fit items-center gap-2 rounded-lg bg-primary-color px-4 py-2 text-sm font-semibold text-primary-on transition-colors hover:bg-primary-dark"
            >
